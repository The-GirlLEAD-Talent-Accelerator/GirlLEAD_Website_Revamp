...
const FocusSection = () => {
  ...
  return (
    <section className="w-full lg:px-4 py-20 flex flex-col items-center overflow-hidden dark:bg-gray-950 transition-colors duration-700">
      {/* Title */}
      <Motion.h2
        className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-gray-100 mb-12 text-center"
...
//           <img
//             src="/focus-image1.png"
//             alt="Tech Skills"
//             className="w-full h-64 object-cover rounded-t-lg"
//           />
//           <div className="bg-[#014451] w-full p-3 rounded-b-lg text-white">
//             <h3 className="text-xl font-semibold mb-2">Tech Skills</h3>
//             <p className="text-[14px] font-thin">
//               Digital literacy, coding, data analytics.
//             </p>
//           </div>
//         </div>
...
//             </h3>
//             <p className="text-[14px] font-thin">
//               Business building, problem-solving, financial literacy.
//             </p>
//           </div>
//         </div>
...
//             <p className="text-[14px] font-thin">
//               Communication, mentoring, personal development.
//             </p>
//           </div>
//         </div>
//       </div>

//       <button className="mt-12 px-6 py-3 bg-teal-600 text-white text-sm font-medium rounded-full hover:bg-teal-700 transition">
//         Start Your Journey
//       </button>
//     </section>
//   );
