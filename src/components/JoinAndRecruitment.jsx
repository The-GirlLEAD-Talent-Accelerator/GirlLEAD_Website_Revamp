const joinUrl = "https://docs.google.com/forms/d/e/1FAIpQLSeQYaOkutAMgOrE-pXAUFOReqPbh7mysGV3_FN5rKTLB25Xpw/closedform";
  ...
  return (
    <div className="w-full bg-[#dff2f2]">
      ...
      <section className="py-16 px-8 max-w-5xl mx-auto">
        ...
        <div className="flex items-start justify-center mb-12 overflow-x-auto">
          {steps.map((step, i) => (
