...
const TestimonialCard = ({ testimonial, index, isMobile }) => (
  <Motion.div
    className={`bg-bg-mute p-8 rounded-2xl shadow-sm border border-border-soft flex flex-col justify-between ${
      isMobile ? 'w-[85vw] mx-auto min-h-[320px]' : 'min-h-[280px]'
    }`}
...
const ImpactAssociateAlumniStories = ({
    ...
    <div className={`${className} w-full m-auto py-12 overflow-hidden transition-colors`}>
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <Motion.h2
          ...
          viewport={{ once: true }}
        >
          Impact Associate Alumni Stories
        </Motion.h2>
...
export default ImpactAssociateAlumniStories;